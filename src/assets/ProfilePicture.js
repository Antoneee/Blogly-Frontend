...
const profilePicture = (props) => {
  return (
    <div
      className={`${
        props.className
          ? styles[`${props.className}-container`]
          : styles["profile__picture-container"]
      }
      }`}
    >
      <svg
        ...
        viewBox="0 0 698 698"
        className={`${
          props.className ? styles[props.className] : styles["profile__picture"]
        }
        }`}
      >
        <defs>
          <linearGradient
            id="b247946c-c62f-4d08-994a-4c3d64e1e98f-258"
            x1="349"
            y1="698"
            x2="349"
        ...
        <g opacity="0.5">
          <circle
            ...
            cy="349"
            r="349"
            fill="url(#b247946c-c62f-4d08-994a-4c3d64e1e98f-258)"
          />
        </g>
